...
def test_case_0094():
    msg = 'Проехала с 07.00 до 08.00 обе таможни Новоазовск. Ни-ко-го! Ехали две женщины и дети. Перед таможней Новоазовска ДНР проверили наличие мужчин в машине.'
    result = get_valid_data(msg)
    # assert result is None
