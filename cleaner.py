...
AUX = (
    ...
    'пусто?', '0 забит', 'одна за одной', 'перед навесом',
    '2 таможни', 'фуры и автобусы', 'впускают фуры', 'опять', 'пустой багажник',
)
DIGITS = (
...
RE_OTHER = (
    ...
    r'(льгота|н[еи][йи]?тралка|навес) \d+', r'ноль.+забит', r'человек \d+ - \d+',
)
